export const WRITE_NOTIFICATION_REPOSITORY = Symbol("WRITE_NOTIFICATION_REPOSITORY");
export const READ_NOTIFICATION_REPOSITORY = Symbol("READ_NOTIFICATION_REPOSITORY");
