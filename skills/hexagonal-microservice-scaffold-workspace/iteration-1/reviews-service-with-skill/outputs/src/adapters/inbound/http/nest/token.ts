// src/adapters/inbound/http/nest/token.ts

export const WRITE_REVIEW_REPOSITORY = Symbol("WRITE_REVIEW_REPOSITORY");
export const READ_REVIEW_REPOSITORY = Symbol("READ_REVIEW_REPOSITORY");
...
export const REVIEW_CACHE = Symbol("REVIEW_CACHE");
